...
echo "Start to build apk..."
      ...
      # shellcheck disable=SC2181
      if [ $? -eq 0 ]; then
        apkFilePath="./app/build/outputs/apk/debug/app-debug.apk"
        apkFilePath_Debug="./app/build/outputs/apk/debug/app-debug.apk"
        apkFilePath_Release="./app/build/outputs/apk/release/app-release-unsigned.apk"
